...
class SVHN:
	...
	def __init__(self,path=None,select=[],unbalance=1.,shuffle=True,output_size=[28,28],output_channel=1,split='train'):
	...
	def class_next_batch(self,num_per_class):
		...
		return np.array(selfimages),get_one_hot(selflabels,self.num_classes)
