...
class LeNetModel(object):
    ...
    def g(self, x, training=False):
        ...
        fc2 = fc(fc1, 500, self.num_classes, relu=False,bn=False, training=training, name='fc2')
        return fc2
	...
	with tf.variable_scope('reuse_inference') as scope:
        ...
        with tf.variable_scope('reuse_inference') as scope:
            ...
            target_pred_onehot = tf.one_hot(tf.argmax(target_pred, 1), self.num_classes)
            self.chose_rate = tf.constant(1.)
